...
folder_names = ['formic_acid_%d'%ii for ii in range(1) ]
...
for ii,folder_name in enumerate(folder_names):
    ...
    np.savetxt('formic_acid_broad_%02d.dat'%(ii+1), data[folder_name])
...
np.savetxt('formic_acid_broad_av.dat', data['mean'])

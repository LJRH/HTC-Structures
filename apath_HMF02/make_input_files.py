...
path = '/home/christoph/atoms/HTC-Structures/apath_HMF02/'
fname = 'apath_HMF02.xyz'
# read xyz file
...
for ii,atom in enumerate(all_ex_atoms):
    ...
    ggaf.write('IntegralThresh 1.000e-6 \n')
    ggaf.close()
    # xrs run
    ...
    xrsf.write('IntegralThresh 1.000e-6 \n')
    xrsf.close()
    # xch run
    ...
    xchf.write('IntegralThresh 1.000e-6 \n')
    xchf.close()

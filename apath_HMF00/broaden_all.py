...
folder_names = ['apath_HMF00_%d'%ii for ii in range(10) ]
...
for ii,folder_name in enumerate(folder_names):
    ...
    np.savetxt('apath_HMF00_broad_%02d.dat'%(ii+1), data[folder_name])
...
np.savetxt('apath_HMF00_broad_av.dat', data['mean'])
